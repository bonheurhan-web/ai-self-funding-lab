...
These documents are the operating system for AI Self-Funding Lab:

- `MISSION.md` - purpose and measurable company objective
- `VISION.md` - desired long-term company state
- `ENGINEERING.md` - naming, testing, commit, and CI standards
